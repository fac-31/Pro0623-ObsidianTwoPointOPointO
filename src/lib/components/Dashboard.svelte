...
>
	<Pane defaultSize={80} minSize={20} class="relative overflow-y-auto" role="region" aria-label="Main Content">
		{#if showSearchBar}
	...
	<Pane defaultSize={30} minSize={25} role="region" aria-label="Information and Query Panel">
